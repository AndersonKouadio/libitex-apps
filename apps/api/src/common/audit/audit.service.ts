...
export const AUDIT_ACTIONS = {
  ...
  STOCK_INVENTORY_APPLIED: "STOCK_INVENTORY_APPLIED",
  INGREDIENT_INVENTORY_APPLIED: "INGREDIENT_INVENTORY_APPLIED",
  // Ingredient
  ...
  // Fidelite
  FIDELITE_POINTS_ADJUSTED: "FIDELITE_POINTS_ADJUSTED",
  FIDELITE_CONFIG_UPDATED: "FIDELITE_CONFIG_UPDATED",
  // Promotions (Module 11 D1)
  PROMOTION_CREATED: "PROMOTION_CREATED",
  PROMOTION_UPDATED: "PROMOTION_UPDATED",
  PROMOTION_DELETED: "PROMOTION_DELETED",
  PROMOTION_APPLIED: "PROMOTION_APPLIED",
  PROMOTION_APPLY_FAILED: "PROMOTION_APPLY_FAILED",
  // Reservations (Module 12 D1)
